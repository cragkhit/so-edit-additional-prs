    public class BazCompuationFuture implements Future<Baz>, BazComputationSink {
        ...
        @Override
        public Baz get(final long timeout, final TimeUnit unit) throws InterruptedException,
